        ...
        <div class="container">
            <div class="arriv-top">
                ...
                <div class="col-md-6 arriv-right">
                    ...
                    <div class="arriv-info">
                        ...
                        <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                        <div class="crt-btn">
                            <a href="{{route('details')}}">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="arriv-bottm">
                <div class="col-md-8 arriv-left1">
                    <img src="{{asset('assets/frontend/images/3.jpg')}}" class="img-responsive" alt="">
                ...
                <div class="col-md-4 arriv-right1">
                    <img src="{{asset('assets/frontend/images/4.jpg')}}" class="img-responsive" alt="">
                    <div class="arriv-info2">
                        <a href="{{route('details')}}"><h3>Trekking Shoes<i class="ars"></i></h3></a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="arriv-las">
                <div class="col-md-4 arriv-left2">
                    <img src="{{asset('assets/frontend/images/5.jpg')}}" class="img-responsive" alt="">
                    <div class="arriv-info2">
                        <a href="{{route('details')}}"><h3>Casual Glasses<i class="ars"></i></h3></a>
                    </div>
                </div>
                <div class="col-md-4 arriv-middle">
                    <img src="{{asset('assets/frontend/images/6.jpg')}}" class="img-responsive" alt="">
                ...
                <div class="col-md-4 arriv-right2">
                    <img src="{{asset('assets/frontend/images/7.jpg')}}" class="img-responsive" alt="">
                    <div class="arriv-info2">
                        <a href="{{route('details')}}"><h3>Elegant Watches<i class="ars"></i></h3></a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
