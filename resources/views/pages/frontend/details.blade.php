            ...
            <div class="row single">
                <div class="col-md-9 det">
                                ...
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image"
                                             src="{{asset('assets/frontend/images/d1.jpg')}}" class="img-responsive"/>
                    ...
                    <div class="single-bottom1">
                        <h6>Details</h6>
                        <p class="prod-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                            ...
                            feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option</p>
                    </div>
                    <div class="single-bottom2">
                        ...
                        <div class="product">
                            <div class="product-desc">
                                <div class="product-img">
                                    <img src="{{asset('assets/frontend/images/w8.jpg')}}" class="img-responsive "
                                         alt=""/>
                                </div>
                                <div class="prod1-desc">
                                    <h5><a class="product_link" href="#">Excepteur sint</a></h5>
                                    <p class="product_descr"> Vivamus ante lorem, eleifend nec interdum non, ullamcorper
                                        et arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
                        ...
                        <div class="product">
                            <div class="product-desc">
                                <div class="product-img">
                                    <img src="{{asset('assets/frontend/images/w10.jpg')}}" class="img-responsive "
                                         alt=""/>
                                </div>
                                <div class="prod1-desc">
                                    <h5><a class="product_link" href="#">Excepteur sint</a></h5>
