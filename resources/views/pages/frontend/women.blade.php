            ...
            <div class="col-md-9 w_content">
                ...
                <div class="grids_of_4">
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w1.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w2.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w3.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w4.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                ...
                <div class="grids_of_4">
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w5.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w6.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w7.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w8.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                ...
                <div class="grids_of_4">
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w9.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w10.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w11.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
                    ...
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="{{route('details')}}">
                                <img src="{{asset('assets/frontend/images/w12.jpg')}}" class="img-responsive" alt=""/>
                            </a>
                            <h4><a href="{{route('details')}}"> Duis autem</a></h4>
                            <p>It is a long established fact that</p>
                            <div class="grid_1 simpleCart_shelfItem">
