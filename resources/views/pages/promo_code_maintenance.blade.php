...
@section('breadcrumbs-area')
    <div class="breadcrumbs-area clearfix">
        <h4 class="page-title pull-left">Promo Code List</h4>
                    ...
                    <div class="card-body">
                        <h4 class="header-title">
                            ...
                            <button style="float: right; padding-bottom: 1%" type="button" class="btn btn-primary"
                                    data-toggle="modal"
                                    data-target="#exampleModal">Create Promo Code
                            </button>
                        </h4>
            ...
            baseTable = $('#baseTable').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function (promo_code) {
                            return '<button type="button" class="btn btn-info" id="edit_btn" data-toggle="modal" data-target="#edit">Edit</button>\n' +
                                '  <a type="button" href="{{url('/promo_code/active_inactive').'/'}}' + promo_code + '" id="active" class="btn btn-warning">Active/In-Active</a>\n' +
                                '  <a type="button" href="{{url('/promo_code/delete').'/'}}' + promo_code + '" id="active" class="btn btn-danger">Delete</a>';
                        }
                    },
                ],
            });
